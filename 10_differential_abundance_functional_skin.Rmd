...
```
```{r comunity_elem_diff_skin, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
adonis2(GIFTs_functions_community_dist ~ environment,
        ...
        data = sample_metadata %>% 
            filter(sample %in% labels(GIFTs_functions_community_dist)) %>% 
            arrange(match(sample,labels(GIFTs_functions_community_dist))), 
        permutations = 999)
```

```{r comunity_elem_diff_plot_skin, comment="", echo=FALSE, message=FALSE, warning=FALSE}
