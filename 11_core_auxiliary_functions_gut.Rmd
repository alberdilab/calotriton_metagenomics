...
```{r core_microbiota_selection_microdiversity, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r high_microbiota_selection_microdiversity, comment="", echo=FALSE, message=FALSE, warning=FALSE}
environment_prevalence %>%
  group_by(genome) %>%
...
```{r low_microbiota_selection_microdiversity, comment="", echo=FALSE, message=FALSE, warning=FALSE}
environment_prevalence %>%
  group_by(genome) %>%
...
```{r core_microbiota_genome_size_gut ,comment="", echo=FALSE, message=FALSE, warning=FALSE}
core_microbiota %>% 
