...
```{r load_read_counts_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r load_genome_metadata_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r load_genome_hits_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r load_genome_annotations_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r filter_coverage_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
min_coverage=0.3
...
```{r calculate_genome_counts_unfiltered_gut, warning=FALSE, comments="", message=FALSE, eval=FALSE}
readlength=150
