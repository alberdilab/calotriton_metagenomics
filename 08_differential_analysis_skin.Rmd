...
```{r load_data_mag_filtdamr_diffe_skin, comment="", message=FALSE, warning=FALSE}
load("data/skin/data.Rdata")
```

```{r phyloseq_skin2, comment="", message=FALSE, warning=FALSE}
#Phyloseq object
...
```{r ancombc_skin, comment="", message=FALSE, warning=FALSE}
...
```{r ancom_rand1_skin, comment="", message=FALSE, warning=FALSE}
...
```{r ancombc_rand_plot_mag_skin, comment="", message=FALSE, warning=FALSE, fig.height=10, fig.width=8, fig.fullwidth=TRUE}
