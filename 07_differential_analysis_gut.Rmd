...
```{r load_data_mag_filtdamr_diffe_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r phyloseq_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE}
#Phyloseq object
...
```{r ancombc_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r ancom_rand1_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r ancombc_rand_plot_mag_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE, fig.height=10, fig.width=8, fig.fullwidth=TRUE}
ancom_mag_gut_table %>%
...
```{r ancom_rand_volcano_mag_gut, comment="", echo=FALSE, message=FALSE, warning=FALSE}
